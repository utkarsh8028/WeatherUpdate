...
public class TestProvider extends AndroidTestCase {
    ...
    public void testGetType() {
        ...
        // content://.android.sunshine.app/weather/94074
    ...
    public void testInsertReadProvider() {
        ...
        // Get the joined detail and Location data
        ...
        TestUtilities.validateCursor("testInsertReadProvider.  Error validating joined detail and Location Data.",
                weatherCursor, weatherValues);

        // Get the joined detail and Location data with a start date
        weatherCursor = mContext.getContentResolver().query(
        ...
        TestUtilities.validateCursor("testInsertReadProvider.  Error validating joined detail and Location Data with start date.",
                weatherCursor, weatherValues);

        // Get the joined detail data for a specific date
        weatherCursor = mContext.getContentResolver().query(
        ...
        TestUtilities.validateCursor("testInsertReadProvider.  Error validating joined detail and Location data for a specific date.",
                weatherCursor, weatherValues);
    }
